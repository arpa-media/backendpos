...
return new class extends Migration
{
    ...
    private const MENU_CODE = 'cogs-ingredient-recipes';
    private const MENU_PATH = '/cogs/ingredient-recipes';
    private const PERMISSION_PREFIX = 'cogs.ingredient';
    ...
    private function seedMatrixRows(string $portalId, string $menuId, $now): void
    {
        ...
        foreach ($roles as $role) {
            ...
            foreach ($scopes as $levelId) {
                ...
                $existing = $this->menuPermission((string) $role->id, $levelId, $menuId);
                if ($existing) {
                    continue;
                }
