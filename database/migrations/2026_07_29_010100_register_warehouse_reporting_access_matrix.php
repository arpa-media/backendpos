...
return new class extends Migration
{
    ...
    private const MENUS = [
        [
            'code' => 'warehouse-reports-analytics',
            'name' => 'Reports & Analytics',
            'path' => '/warehouse/reports',
            'sort_order' => 900,
            'permission' => 'warehouse.reporting',
        ],
        [
            'code' => 'warehouse-operational-reconciliation',
            'name' => 'Operational Reconciliation',
            'path' => '/warehouse/reports/reconciliation',
            'sort_order' => 910,
            'permission' => 'warehouse.operational_reconciliation',
        ],
    ];
    ...
    public function up(): void
    {
        ...
        // Dashboard Iterasi 01 tetap memakai path dan permission yang sama, tetapi label DB dinormalkan sebagai dashboard final.
        DB::table('access_menus')
            ->where('code', 'warehouse-operations-dashboard')
            ->update([
        ...
        foreach (self::MENUS as $menu) {
            ...
            DB::table('access_menus')->updateOrInsert(
                ...
                [
                    ...
                    'permission_create' => $menu['permission'].'.export',
                    'permission_update' => $menu['permission'].'.run',
            ...
            foreach (['view', 'export', 'print', 'run'] as $action) {
