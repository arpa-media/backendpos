...
return new class extends Migration
{
    ...
    private const MENUS = [
        ['code' => 'warehouse-stock-request-fulfillment', 'name' => 'Stock Request Fulfillment', 'path' => '/warehouse/stock-requests/fulfillment', 'sort_order' => 330, 'permission' => 'warehouse.fulfillment.review'],
        ['code' => 'warehouse-checker-prepare-tasks', 'name' => 'Checker Prepare', 'path' => '/warehouse/tasks/checker-prepare', 'sort_order' => 340, 'permission' => 'warehouse.fulfillment.task'],
        ['code' => 'warehouse-delivery-orders', 'name' => 'Delivery Order', 'path' => '/warehouse/delivery-orders', 'sort_order' => 350, 'permission' => 'warehouse.delivery_order'],
    ];
    ...
    public function up(): void
    {
        ...
        foreach ([
            'warehouse.fulfillment.assign',
            'warehouse.fulfillment.task.scan',
            'warehouse.fulfillment.task.shortage',
            'warehouse.fulfillment.task.override',
            'warehouse.delivery_order.dispatch',
            'warehouse.delivery_order.print',
        ] as $permission) {
        ...
        foreach ($roles as $role) {
            ...
            foreach (array_merge([null], $levels) as $levelId) {
                ...
                DB::table('access_role_menu_permissions')->insert([
                    ...
                    'can_edit' => $enabled, 'can_delete' => $enabled && strtoupper((string) $role->code) === 'ADMIN',
