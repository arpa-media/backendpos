...
return new class extends Migration
{
    ...
    private const MENUS=[
        ['code'=>'warehouse-productions','name'=>'Production','path'=>'/warehouse/production','sort_order'=>500,'permission'=>'warehouse.production'],
        ['code'=>'warehouse-checker-production-tasks','name'=>'Checker Production','path'=>'/warehouse/tasks/checker-production','sort_order'=>510,'permission'=>'warehouse.production.checker'],
    ];
    ...
    public function up(): void
    {
        ...
        foreach(self::MENUS as $menu){
            ...
            DB::table('access_menus')->updateOrInsert(['code'=>$menu['code']],[
                ...
                'permission_view'=>$menu['permission'].'.view','permission_create'=>$menu['permission'].'.create',
                'permission_update'=>$menu['permission'].'.update','permission_delete'=>$menu['permission'].'.delete',
        ...
        foreach([
            'warehouse.production.submit','warehouse.production.assign','warehouse.production.release','warehouse.production.done',
            'warehouse.production.approve','warehouse.production.print','warehouse.production.checker.scan','warehouse.production.checker.override',
