...
return new class extends Migration
{
    ...
    private const MENUS = [
        [
            'code' => 'warehouse-logistics-sales-deliveries',
            'name' => 'Delivery Order & GR',
            'path' => '/warehouse/logistics/sales-deliveries',
            'sort_order' => 610,
            'base' => 'warehouse.logistics.delivery',
        ],
        [
            'code' => 'warehouse-logistics-sales-returns',
            'name' => 'Return & Discrepancy',
            'path' => '/warehouse/logistics/sales-returns',
            'sort_order' => 620,
            'base' => 'warehouse.logistics.return',
        ],
    ];
    ...
    public function up(): void
    {
        ...
        foreach (self::MENUS as $menu) {
            foreach (['view', 'create', 'update', 'approve', 'dispatch', 'receive'] as $action) {
                if (Schema::hasTable('permissions')) {
                    Permission::findOrCreate("{$menu['base']}.{$action}", $guard);
                }
            }
        }
        ...
        foreach (self::MENUS as $menu) {
            ...
            DB::table('access_menus')->updateOrInsert(
                ...
                [
                    ...
                    'permission_view' => "{$menu['base']}.view",
                    'permission_create' => "{$menu['base']}.create",
                    'permission_update' => "{$menu['base']}.update",
                    'permission_delete' => "{$menu['base']}.approve",
                    'is_active' => true,
