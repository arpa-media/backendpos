...
class ReimburseOrderItem extends Model
{
    use HasUlids;

    protected $table = 'pur_reimburse_order_items';
    ...
    public function order() { return $this->belongsTo(ReimburseOrder::class, 'reimburse_order_id'); }
